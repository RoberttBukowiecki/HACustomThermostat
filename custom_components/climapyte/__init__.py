...
async def async_setup_entry(hass, entry):
    ...
    config = entry.data
    thermostat = CustomThermostat(hass, config)
    hass.data["custom_thermostat"] = thermostat  # Storing the instance in hass.data
    hass.helpers.entity_platform.async_add_entities([thermostat])
    return True
...
class CustomThermostat(ClimateEntity):
    ...
    def __init__(self, hass, config):
        ...
        self._temperature_offset = config.get("temperature_offset", 0)
